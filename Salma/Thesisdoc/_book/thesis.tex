...
\title{A Hedonic Price Model of Property Prices in Portland, Oregon}
\author{Salma Huque}
...
My heartfelt thanks to Ryan Kobler, the most brilliant shining beacon of all that is good and worthy in my life. I will never be able to thank you enough for the unfaltering friendship and support you've given me over the last two years. This thesis is just as much a product of your hard work as it is mine.

\par

Thank you to Noelwah Netusil, for bringing your support and experience to this project, as well as your enthusiasn with my job search. You're the best advisor I could have gotten! Thank you to Jon Rork for giving me a little (metaphorical) shake when I'm overthinking. Thank you to Jeff Parker for the cinnamon buns and corny jokes. And thanks to Kelly McConville for being the best professor I've had in my entire life. Working with you on forestry data gave me a .

\par

Thank you to the folks at BPS, who did a whole lot of grunt work to make this work possible. In particular, thanks to Al Burns for entrusting us with this monster task, and to Nick Kobel for his earnest support and killer cake recipe. This definitely would not have been possible without you.

\par

All my love and thanks to Mama and Baba for talking to me on the phone every single day for the last four years. I have said so many embarrassing things and you have made fun of me every single time. Your encouragement makes me .

\par

And lastly, thanks to the econ lunch crew: Will, Shulav, Annie, Jacob G, Claire, and Zeki, who always remind me that I made the right choice not doing math-econ; , to Mary Brady, the love of my life and my eternal coffeeshop study buddy; and to Dylan, . I'm happy we're all still friends four years later.
...
\hypertarget{hedonic}{%
\chapter{The Hedonic Price Model}\label{hedonic}}

In economic theory, the value of goods and services is determined by the market value, i.e., how much people are willing to pay for them. This price is the result of the intersection of demand from consumers and supply from producers for the good. However, not all goods are sold on a market. These include environmental goods such as clean air and water or component goods that make up a good that is sold on the market. A classic example of a this is Andrew Court's seminal 1939 paper studying the price of automobiles. He used variations in automobile components (horsepower, breaking capacity, tire size) to determine the value of each component part and was then able to infer the price of a given automobile. This method is important in environmental analyses because there is no market of producers and consumers trading a good. In these situations, economists rely on non-market valuation methods to determine how much people value these non-market goods.

\par

The two broad categories of non-market valuation techniques are stated preference and revealed preference. The first category, stated preference methods, uses surveys to ask people questions about a hypothetical market (Kolstad 2011). For example, a study may ask people to choose between bundles of goods of varying quality to determine preferences which are then quantified. Or a study may directly ask respondents whether or not they are willing to pay x amount for a bundle. Both study designs rely on their respondents' ability to correctly indicate their own preferences and willingness to pay for goods and services, which can lead to inaccurate estimates. In addition to potential self-reporting concerns, the wide variety of survey designs used makes it difficult to compare one study to another. The contingent valuation community has yet to agree upon a set of rules surveys need to follow to be considered ``valid'', and this lack of a systematic research agenda makes it difficult to compare studies and develop a literature. Finally, it has been established that contingent valuation tends to overestimate values (Boyle 2017). As a result of the above concerns, contingent valuation is not a useful technique to employ for this study, though survey findings can be useful in ``filling in the blanks'' of other methods.

\par

The second category of non-market valuation is revealed preference methods. This method bypasses the stated preference issue of self-reporting by using a related market to infer the value of a non-market good. The hedonic method is one such method which seeks to break down a larger market good into its component parts, and then obtain estimates for the value of its constituent parts (Rosen 1974). These values are what BPS would call the ``discount prices'' for each constraint, but what I will call ``marginal price'' going forward to reflect the existing hedonic literature. We chose to use the hedonic method due to the ease with which a property's sale price can be broken down into different characteristics.

\par

This chapter is divided into four sections. Section 2.1 provides the theoretical framework for the demand side of the hedonic model and the ``bid function.'' Section 2.2 looks at supply side and the ``offer function.'' Section 3.3 looks at the two functions in equilibrium and Section 2.4 applies this framework to the housing property market. Note that this chapter uses notation from Taylor's chapter ``The Hedonic Method'' and draws heavily from both Taylor (2017) and Freeman (2003).

\hypertarget{the-demand-side-demand}{%
\section{2.1 The Demand Side \{demand\}}\label{the-demand-side-demand}}

\hypertarget{the-supply-side-supply}{%
\section{2.2 The Supply Side \{supply\}}\label{the-supply-side-supply}}

\hypertarget{the-market-in-equilibrium-equilibrium}{%
\section{2.3 The Market in Equilibrium \{equilibrium\}}\label{the-market-in-equilibrium-equilibrium}}

\hypertarget{the-hedonic-property-model}{%
\section{2.4 The Hedonic Property Model}\label{the-hedonic-property-model}}
