...
bliconstraints <- st_read(gdb2, layer = "bli_constraints_all")
...
datanames <- c("constraints", "gisimpcop", "impsegcop", "gispropcop", "allpropcop", "segchar", "rollhist", "rollvals", "impseg", "salescop","school", "imp", "taxlots", "bliconstraints", "footprints") #missing rollwide
datanames 
