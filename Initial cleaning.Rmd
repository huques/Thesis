...
### Merge impsegcop_wide to taxlots
Impsegcop_wide has the variables Attic, Garage, Patio, and the square footages associated with each. So we left_join these characteristics to the taxlots by PropertyID. 

```{r}
impsegcop_wide$PROPERTYID <- impsegcop_wide$PropID # add variable 
