...
gdb <- "/Users/kobleary/Desktop/DATA/data2.gdb"
...
gdb2 <- "/Users/kobleary/Desktop/DATA/data1.gdb"
...
gdb3 <- "/Users/kobleary/Desktop/DATA/data_20191112.gdb"
...
gdb4 <- "/Users/kobleary/Desktop/DATA/tree_canopy.gdb"

bli_constraints_v2 <- st_read(gdb4, "bli_constraints_v2_pts_run4")

#----------------------
# SHP sent 11/25 via email
ugb <- st_read("/Users/kobleary/Desktop/DATA/ugb/ugb.shp") 


#----------------------
# GDB sent 2/10 via email
gdb5 <- "/Users/kobleary/Desktop/DATA/canopy_20200210.gdb"

canopy <- st_read(gdb5, "canopy_taxlot_intersect")

#----------------------
# GDB 2/11 from PortlandMaps
walk_gdb <- "/Users/kobleary/Desktop/DATA/Complete_Neighborhoods_Scoring_Surface"
...
### Percent Vacant Properties within Half Mile
...
fugly <- st_join(st_centroid(fugly), non_id_constraints)
```
...
zoningaug2014 <- st_read("/Users/kobleary/Desktop/DATA/Zoning_History/Zoning_2014_Aug_pdx.shp")
zoningfeb2014 <- st_read("/Users/kobleary/Desktop/DATA/Zoning_History/Zoning_2014_Feb_pdx.shp")
zoningaug2015 <- st_read("/Users/kobleary/Desktop/DATA/Zoning_History/Zoning_2015_Aug_pdx.shp")
zoningfeb2015 <- st_read("/Users/kobleary/Desktop/DATA/Zoning_History/Zoning_2015_Feb_pdx.shp")
zoningaug2016 <- st_read("/Users/kobleary/Desktop/DATA/Zoning_History/Zoning_2016_Aug_pdx.shp")
zoningfeb2016 <- st_read("/Users/kobleary/Desktop/DATA/Zoning_History/Zoning_2015_Feb_pdx.shp")
zoningaug2017 <- st_read("/Users/kobleary/Desktop/DATA/Zoning_History/Zoning_2017_Aug_metro.shp")
zoningaug2018 <- st_read("/Users/kobleary/Desktop/DATA/Zoning_History/Zoning_2018_Aug_pdx.shp")
zoningfeb2018 <- st_read("/Users/kobleary/Desktop/DATA/Zoning_History/Zoning_2018_Feb_pdx.shp")
...
crosswalk <- read_xlsx("/Users/kobleary/Desktop/DATA/zoning_crosswalk.xlsx")
crosswalk %<>%
  rename(sale_zone = `Base Zone`)

# Join use-crosswalk to generate prop_type variable: MFR, SFR, mixed use
zones_over_time %<>%
  left_join(crosswalk, by = "sale_zone") %>%
  dplyr::rename(prop_type = Simplified) %>%
  dplyr::mutate(prop_type = case_when(sale_zone == "CM"| sale_zone == "CG"|sale_zone == "CN1"|
                            sale_zone == "CN2"|sale_zone == "CS" ~ "Mixed Use",
                          sale_zone == "CO1"|sale_zone == "CO2" ~ "Non-conforming",
                          TRUE ~ prop_type)
  ) %>%
  st_drop_geometry() %>%
  select(STATE_ID, prop_type, sale_zone) # only chose these 2 vars, rather than having historic
# zones over time--we can decide if historic zones matter
