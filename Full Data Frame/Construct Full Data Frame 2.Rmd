...
# join to dataframe 
fugly <- left_join(fugly, vacant_var, by = c("STATE_ID" = "STATE_ID.x"))
...
```{R}
#write.csv(df, here("DATA", "altered", "thesis-data.csv"))
```
